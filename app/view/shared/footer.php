<div id="footer" class="clear">
    	<div class="wrapper">
        	<div id="other">
            	<p>Footeriin tulee kaikenlaista hieman merkityksettömämpää sälää kuten linkkejä ja muita.</p>
            </div>
            <div id="author" >
        		<address class="clear">
                ...
                Projekti <a href="https://github.com/aleksir/www-julk">GitHubissa</a><br />
